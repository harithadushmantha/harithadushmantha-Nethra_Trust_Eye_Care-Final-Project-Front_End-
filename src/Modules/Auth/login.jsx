...
import EyeLogo from './Image/logo.jpeg';
    ...
    <Formik
      ...
      onSubmit={async (values, { setSubmitting, resetForm }) => {
        ...
        try {
          ...
          window.location = '/';
          toast.info("Welcome - Nethra Trust Eye Care Center")
        } catch (ex) {
                ...
                <div className="animate form login_form">
                  <section className="login_content">
                    <form onSubmit={handleSubmit}>
                      ...
                      <div>
                        <button disabled={!isValid} type="submit" style={{ backgroundColor: "white", color: "rgb(108, 109, 108)" }} className="btn btn-secondary submit" >Log in</button>
                      </div>
                      <div className="separator">
                        ...
                        <div>
                          <h1 className="grayout" style={{ fontSize: "20px" }}>
                            <img src={EyeLogo} alt="jjjj" width="40px" height="40px"></img> Nethra Trust Eye Care</h1>
                          <p className="grayout">©2022 All Rights Reserved - Privacy and Terms</p>
                        </div>
                      </div>
                    </form>
                  </section>
