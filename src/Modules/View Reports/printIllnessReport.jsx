...
import './style.css';
import NethraTrust from '../View Patients/printContent/Image/logo.jpeg';
...
const PrintIllnessReport = ({match,location}) => {
       ...
       useEffect(()=>{
              ...
              const getillness = async () => {
                    ...
                    console.log("aaaa",queryData.l_catract);
                    console.log("aaaa",queryData);
                    
                    if (queryData.l_catract=="Yes") {setleftCatract(" √ ")}
                    else {setleftCatract(" -- ")};
                    console.log("aaaa",queryData.r_catract);
          ...
          {({
           values,touched,handleChange,handleSubmit,handleBlur,errors
            ...
            <input type='button' style={{ position: 'relative', float: 'right' }}
                   onClick={() => print(ids)} value='Print Report' className="btn btn-warning"/>
            ...
            <img src={NethraTrust}  alt="Image" width="130px" height="130px"/>
            <h6>Nethra Community Eye Care Center</h6> <p >1102/1/1, Dehiwala Road, Maharagama, Sri Lanka.  Phone: +94 77 6297972</p>
...
<td></td>
            ...
            <td colSpan="2"><input 
                ...
                <input type='button' style={{ position: 'relative', float: 'right',backgroundColor:"rgb(238, 112, 9)" }}
                       onClick={() => print(ids)} value='Print Report' className="btn btn-warning" />
            </div>
