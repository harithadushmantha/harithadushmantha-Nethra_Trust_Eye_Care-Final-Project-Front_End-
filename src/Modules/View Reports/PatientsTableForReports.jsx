        ...
        <div>
            <div className="col-md-9">
                <div className="x_title">
                    <h2 className="mainTopicP">Registered Patients for View Reports</h2>
