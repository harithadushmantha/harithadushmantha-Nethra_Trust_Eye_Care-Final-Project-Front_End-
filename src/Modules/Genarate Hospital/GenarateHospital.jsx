...
const validationSchema = Yup.object().shape({
    ...
    .required(" Hospital Name is Requird")
...
const GenarateHospital = () => {
    return ( 
         <div>
            ...
            toast.info("Successfully added new hopital")
            resetForm();
           }}
            >
                {({
             ...
             <div  className="col-md-12 col-sm-12 ">
                    ...
                    <div className="x_title">
                           <h2 className="mainTopicP">Genarate Hospital</h2>
                     ...
                     <div className="item form-group title">
                       <label className="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Hospital Name </label>    
                         <div className="col-md-5 col-sm-5 ">
                                 ...
                                 ></input>
                                 <Error  touched={touched.hospitalname} message={errors.hospitalname} />
                                </div>
                             </div>
                      ...
                      <div className="item form-group title">
                        <label className="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Phone Number </label>    
                          <div className="col-md-5 col-sm-5 ">
                                 ...
                                 ></input>
                                 <Error  touched={touched.hospitalPhonenumber} message={errors.hospitalPhonenumber} />
                                </div>
                             </div>
