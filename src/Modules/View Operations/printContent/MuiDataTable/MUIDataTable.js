...
class MUIDataTable extends React.Component {
 ...
 <p style={{textAlign:'center'}}><img src={NethraTrust}  alt="Image"/>
    <h6 style={{textAlign:'center'}}>Nethra Community Eye Care Center</h6> <p style={{textAlign:'center'}}>1102/1/1, Dehiwala Road, Maharagama, Sri Lanka.  Phone: +94 71 6297972</p>
