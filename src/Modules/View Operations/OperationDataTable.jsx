    ...
    const column = [

        {
            path: 'name', lable: 'Name', content: operations =>
                (
                    <a href={`/view-single-operation/${operations._id}?id=${operations.patient.nic}&name=${operations.patient.name}&hospital=${operations.hospital.name}&date=${operations.date}&payType=${operations.payType}&status=${operations.status}&eye=${operations.eye}`}>{operations.patient.name}</a>
                )
        },
        {
        ...
        <div>
            <div className="col-md-9">
                <div className="x_title">
                    <h2 className="mainTopicP">Operations Have Done</h2>
