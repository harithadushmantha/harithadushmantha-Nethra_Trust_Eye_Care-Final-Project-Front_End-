...
const HomeLayout = () => {
    ...
    const items = [
        ...
        },
        {
            ...
            onClick,
            items: [
                { name: "registeruser", label: "Register User", onClick, link: `/register-user` },
                { name: "registerdoctor", label: "Register Doctor", onClick, link: `/register-doctor` },
                { name: "registerhospital", label: "Register Hospital", onClick, link: `/register-hospital` }
            ]
        }
    ];
    return (
